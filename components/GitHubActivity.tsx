        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          <div className="rounded-lg border border-accent/20 bg-accent/5 p-4">
            <div className="flex items-center gap-2 mb-2">
              <GitCommit className="text-accent" size={18} />
              <span className="text-sm text-text-secondary">Commits</span>
            </div>
            <div className="text-2xl font-bold text-text-primary">
              {yearlyStats.totalCommits.toLocaleString()}
            </div>
            <p className="text-xs text-text-secondary mt-1">This year</p>
          </div>

          <div className="rounded-lg border border-accent/20 bg-accent/5 p-4">
            <div className="flex items-center gap-2 mb-2">
              <Github className="text-accent" size={18} />
              <span className="text-sm text-text-secondary">Active Repos</span>
            </div>
            <div className="text-2xl font-bold text-text-primary">
